...
export const constantRoutes = [
  ...
  },
  {
    ...
    redirect: '/parkManage',
    name: '基础服务',
    meta: { title: '基础服务', icon: 'basicServices' },
    children: [{
      path: 'parkManage',
      name: '园区管理',
      component: () => import('@/views/basicServices/parkManage/index'),
      meta: { title: '园区管理', icon: 'parkManage' }
    },
    {
      path: 'menuManage',
      name: '菜单管理',
    ...
    },
    {
      ...
      meta: { title: '附件管理', icon: 'attachment' }
    },
  ]
  },

  {
    ...
    name: '日志',
    meta: { title: '日志', icon: 'operationLog' },
    children: [
      {
        path: 'operationLog',
        name: '操作日志',
